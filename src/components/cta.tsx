  ...
  return (
    <section className="py-20 px-[5%]" style={{ backgroundColor: "#dae8e8" }}>
      <div className="w-full max-w-7xl mx-auto rounded-2xl overflow-hidden">
        <div
          className="bg-[#dae8e8] flex overflow overflow-hidden"
          style={{
            backgroundImage:
              "url(/cta/67e3f37152e1d4e437ff880e_bottom-cta_bg.avif)",
          }}
        >
          <div className="flex flex-col flex-1 py-30 pl-20 pr-2.5 items-start">
        ...
        <div className="bg-white flex items-center justify-between py-12 px-10">
